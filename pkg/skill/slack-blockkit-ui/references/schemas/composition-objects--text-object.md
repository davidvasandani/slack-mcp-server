...
The text for the block. This field accepts any of the standard [text formatting markup](https://docs.slack.dev/messaging/formatting-message-text) when `type` is `mrkdwn`. The minimum length is 1 and maximum length is 3000 characters.
