...
An array of [option objects](https://docs.slack.dev/reference/block-kit/composition-objects/option-object). Maximum number of options is 100. If `option_groups` is specified, this field should not be.
...
A [confirm object](https://docs.slack.dev/reference/block-kit/composition-objects/confirmation-dialog-object) that defines an optional confirmation dialog that appears after a menu item is selected.
